...
val FullTermsAndConditions = listOf(
    ...
    TermSection(
        ...
        "La Aplicación gestiona productos con precios unitarios fijos configurados por el desarrollador:\n\n• Empanada: $1.100 COP\n• Dedito: $900 COP\n\nEstos precios no pueden ser modificados por el Usuario. Los montos de cobro, deuda y reportes PDF se calculan automáticamente con base en estos valores."
    ),
    TermSection(
